  ...
  useEffect(() => {
    ...
    if (shipping) {
      const body = {
        ...
        description: 'Payment Intent for Herbs & Clothes',
    ...
    <div>
      {
        ...
        <div>
          ...
          <button
            ...
            className='button is-black yerbaropa-btn submit saved-card-btn'
      ...
      <div className='submit-btn'>
        <button
          disabled={processing}
          className='button is-black yerbaropa-btn submit'
